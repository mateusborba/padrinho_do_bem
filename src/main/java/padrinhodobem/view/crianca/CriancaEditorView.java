 ...
 * @author herbert
 */
public class CriancaEditorView extends javax.swing.JFrame {
     ...
     */
    public CriancaEditorView(Usuario user) {
        this.user = user;
        initComponents();
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        try {
            ...
            Logger.getLogger(CriancaEditorView.class.getName()).log(Level.SEVERE, null, ex);
        }
